  ...
  return (
    <div className="space-y-6">
      <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6">
        <h1 className="text-2xl font-bold text-[#0f172a]">Revision de Informes</h1>
        <p className="text-[#64748b] mt-1">Informes de asignatura entregados por los docentes</p>
      </div>
      ...
      <Card className="border-[#e2e8f0]">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="divide-y divide-[#f1f5f9]">
                ...
                <div key={i.id} className="py-3 flex flex-col sm:flex-row sm:items-center gap-3">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#64748b]">{i.docente} · {periodo?.nombre}</p>
                    </div>
                  </div>
                  <div className="flex flex-wrap items-center gap-3">
                    <span className="text-xs text-[#94a3b8]">{i.fechaEntrega}</span>
            ...
            {filtered.length === 0 && (
              <p className="py-8 text-center text-sm text-[#94a3b8]">No se encontraron informes.</p>
            )}
          </div>
        </CardContent>
      </Card>
